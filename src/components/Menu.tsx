      ...
      <div className="navbar flex flex-row md:mb-2 shadow-lg bg-neutral text-neutral-content">
        ...
        <div className="hidden md:inline md:navbar-center">
          <div className="flex items-stretch">
            <Link href="/">
              <a className="btn btn-ghost btn-sm rounded-btn">All transactions in last 24 hours</a>
            </Link>
            <Link href="/avarage-balance">
              <a className="btn btn-ghost btn-sm rounded-btn">Avarage balance in last 24 hours</a>
            </Link>
          </div>
        </div>
